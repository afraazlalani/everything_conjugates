...
const parts = [
  {
    ...
    desc: "small molecules that bind receptors or transporters to direct delivery.",
  },
  {
    title: "linker",
    desc: "engineered for stability and controlled payload release.",
  },
  {
    title: "payload",
    desc: "potent drugs or imaging agents optimized for conjugation.",
  },
];
      ...
      <main className="relative mx-auto flex w-full max-w-5xl flex-col gap-10 px-6 pb-20 pt-12">
        ...
        >
          ...
          <p className="text-lg text-zinc-600 font-[family-name:var(--font-manrope)]">
            SMDCs use small-molecule ligands to deliver payloads with compact size,
            rapid tissue penetration, and adjustable pharmacokinetics.
            {cite(1)}
            {cite(2)}
          </p>
