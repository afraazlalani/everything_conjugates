      ...
      <main className="relative mx-auto flex w-full max-w-4xl flex-col gap-10 px-6 pb-20 pt-12">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl font-semibold font-[family-name:var(--font-space-grotesk)]">
            chelators keep radionuclides stable
          </h1>
          <p className="text-lg text-zinc-600 font-[family-name:var(--font-manrope)]">
            Chelators secure the radionuclide to the ligand, maintaining stability
            in circulation and preventing off-target release.
          </p>
        </motion.section>
        ...
        <Card className="bg-white/70 border border-white/80">
          ...
          <CardBody className="flex flex-col gap-3 text-sm text-zinc-600">
            <p>
              Chelator choice depends on the radionuclide, desired stability, and
              pharmacokinetics of the ligand.
            </p>
            <p>
              Strong metal binding minimizes release and reduces healthy tissue
              exposure.
            </p>
          </CardBody>
        </Card>
