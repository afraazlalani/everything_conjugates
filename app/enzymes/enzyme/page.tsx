      ...
      <main className="relative mx-auto flex w-full max-w-4xl flex-col gap-10 px-6 pb-20 pt-12">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl font-semibold font-[family-name:var(--font-space-grotesk)]">
            enzymes activate prodrugs locally
          </h1>
          <p className="text-lg text-zinc-600 font-[family-name:var(--font-manrope)]">
            The enzyme component performs catalytic conversion of a prodrug or
            substrate at the target site, amplifying local therapeutic action.
          </p>
        </motion.section>
        ...
        <Card className="bg-white/70 border border-white/80">
          ...
          <CardBody className="flex flex-col gap-3 text-sm text-zinc-600">
            <p>
              Enzyme specificity and turnover impact how efficiently the prodrug
              is activated.
            </p>
            <p>
              Immunogenicity and stability are important factors when selecting
              enzyme candidates.
            </p>
          </CardBody>
        </Card>
